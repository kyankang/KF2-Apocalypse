...
simulated function PostBeginPlay()
{
    ...
    if( iConfigVersion <= 2 )
    {
        LoadingBackgrounds.AddItem("ApocClassicMenu_Assets.LoadingScreen1");
        LoadingBackgrounds.AddItem("ApocClassicMenu_Assets.LoadingScreen2");
        LoadingBackgrounds.AddItem("ApocClassicMenu_Assets.LoadingScreen3");
        LoadingBackgrounds.AddItem("ApocClassicMenu_Assets.LoadingScreen4");
        LoadingBackgrounds.AddItem("ApocClassicMenu_Assets.LoadingScreen5");
