...
{
    Super.PostBeginPlay();
    TravelData = class'ApocGameMode.MS_PC'.Default.TravelData;
...
defaultproperties
{
    InputClass=class'ApocClassicMenu.MenuPlayerInput'

    MainMenuClass=class'ApocClassicMenu.UI_MainMenu'
    StartMenuClass=class'ApocClassicMenu.UI_StartGame'
    ServerBrowserClass=class'ApocClassicMenu.UI_ServerBrowser'
    SettingsMenuClass=class'ApocClassicMenu.UI_SettingsMenu'
    FlashUIClass=class'ApocClassicMenu.UI_FlashMenu'
    LobbyMenuClass=None
}
