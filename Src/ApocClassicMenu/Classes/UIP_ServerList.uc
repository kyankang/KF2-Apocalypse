...
defaultproperties
{
    ...
    ServerDifficultyIcons.Add("ApocClassicMenu_Assets.Easy")
    ServerDifficultyIcons.Add("ApocClassicMenu_Assets.Normal")
    ServerDifficultyIcons.Add("ApocClassicMenu_Assets.Hard")
    ServerDifficultyIcons.Add("ApocClassicMenu_Assets.HellOnEarth")
    
    PasswordIcon="ApocClassicMenu_Assets.passworded"
    VACIcon="ApocClassicMenu_Assets.VAC_Servericon"
    StatsIcon="ApocClassicMenu_Assets.Stats"
