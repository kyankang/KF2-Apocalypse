...
simulated final function InitRep()
{
    ...
    myHUD = KFHUDInterface(FindObject("ApocGameMode.Default__KFHUDInterface",class'KFHUDInterface'));
    if( myHUD != None )
    {
    ...
    MyStyle = GUIStyleBase(FindObject("ApocGameMode.Default__GUIStyleBase",class'GUIStyleBase'));
    if( MyStyle != None )
    {
    ...
    MyGUIController = KF2GUIController(FindObject("ApocGameMode.Default__KF2GUIController",class'KF2GUIController'));
    ...
    /*
    DialogManager = KFClassicTraderDialog(FindObject("ApocGameMode.Default__KFClassicTraderDialog",class'KFClassicTraderDialog'));
    ...
    */
    ...
    KFWaitingMessage(FindObject("ApocGameMode.Default__KFWaitingMessage",class'KFWaitingMessage')).CurrentFont = Font(ObjRef.ReferencedObjects[43]);
    ClassicHumanPawn(FindObject("ApocGameMode.Default__ClassicHumanPawn",class'ClassicHumanPawn')).TraderComBeep = SoundCue(ObjRef.ReferencedObjects[100]);
    
    HealProj(FindObject("ApocGameMode.Default__HealProj",class'HealProj')).ProjectileTemplate = ParticleSystem(ObjRef.ReferencedObjects[165]);
    SpectatorUFO(FindObject("ApocGameMode.Default__SpectatorUFO",class'SpectatorUFO')).StaticMeshComponent.SetStaticMesh(StaticMesh(ObjRef.ReferencedObjects[166]), true);
    SpectatorFlame(FindObject("ApocGameMode.Default__SpectatorFlame",class'SpectatorFlame')).EmitterTemplate = ParticleSystem(ObjRef.ReferencedObjects[167]);
   
    ClassicPawn_ZedBloat(FindObject("ApocGameMode.Default__ClassicPawn_ZedBloat",class'ClassicPawn_ZedBloat')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[123]);
    ClassicPawn_ZedClot_Alpha(FindObject("ApocGameMode.Default__ClassicPawn_ZedClot_Alpha",class'ClassicPawn_ZedClot_Alpha')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[122]);
    ClassicPawn_ZedCrawler(FindObject("ApocGameMode.Default__ClassicPawn_ZedCrawler",class'ClassicPawn_ZedCrawler')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[124]);
    ClassicPawn_ZedFleshpound(FindObject("ApocGameMode.Default__ClassicPawn_ZedFleshpound",class'ClassicPawn_ZedFleshpound')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[125]);
    ClassicPawn_ZedGorefast(FindObject("ApocGameMode.Default__ClassicPawn_ZedGorefast",class'ClassicPawn_ZedGorefast')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[126]);
    ClassicPawn_ZedPatriarch(FindObject("ApocGameMode.Default__ClassicPawn_ZedPatriarch",class'ClassicPawn_ZedPatriarch')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[127]);
    ClassicPawn_ZedScrake(FindObject("ApocGameMode.Default__ClassicPawn_ZedScrake",class'ClassicPawn_ZedScrake')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[128]);
    ClassicPawn_ZedStalker(FindObject("ApocGameMode.Default__ClassicPawn_ZedStalker",class'ClassicPawn_ZedStalker')).PawnAnimInfo = KFPawnAnimInfo(ObjRef.ReferencedObjects[129]);
    ClassicPawn_ZedHusk(FindObject("ApocGameMode.Default__ClassicPawn_ZedHusk",class'ClassicPawn_ZedHusk')).AnimTreeReplacment = AnimTree(ObjRef.ReferencedObjects[130]);
...
defaultproperties
{
    ...
    BaseRef=ObjectReferencer'ApocGameMode_Assets.ObjectRef.MainObj_List'
}