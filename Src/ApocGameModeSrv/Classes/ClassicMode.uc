...
function PostBeginPlay()
{
    ...
    if( KFGI != None )
    {
        ...
        {
            KFGI.AddMutator("ApocGameModeSrv_CDCompat.ClassicModeCD", true);
            Destroy();
            return;
        }
    }
    ...
    AddLoadPackage(ObjectReferencer'ApocGameMode_Assets.ObjectRef.MainObj_List');
    AddLoadPackage(class'ApocGameMode.ClientPerkRepLink');
    AddLoadPackage(SoundCue'ApocClassicMusic.RandomWaveMusic');
    ...
    foreach TraderInventory(Item)
    {
        if( bDisableGameplayChanges )
        {
            Item = Repl(Item, "ApocGameMode.Classic", "KFGame.KF");
        }
    ...
    foreach Perks(MyPerk)
    {
        if( bDisableGameplayChanges )
        {
            switch(MyPerk)
            {
                case "ApocGameMode.ClassicPerk_Berserker":
                    MyPerk = "ApocGameMode.ClassicPerk_Berserker_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Commando":
                    MyPerk = "ApocGameMode.ClassicPerk_Commando_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Support":
                    MyPerk = "ApocGameMode.ClassicPerk_Support_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Medic":
                    MyPerk = "ApocGameMode.ClassicPerk_Medic_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Demolitionist":
                    MyPerk = "ApocGameMode.ClassicPerk_Demolitionist_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Firebug":
                    MyPerk = "ApocGameMode.ClassicPerk_Firebug_Default";
                    break;
                case "ApocGameMode.ClassicPerk_Sharpshooter":
                    MyPerk = "ApocGameMode.ClassicPerk_Sharpshooter_Default";
                    break;
            }
        }
    ...
    foreach DynamicActors(class'ApocGameModeSrv.xVotingHandler',MV)
        break;
    if( MV==None )
        MV = Spawn(class'ApocGameModeSrv.xVotingHandler');
    MV.BaseMutator = Class;

    if( bDisableGameplayChanges )
    {
        AIClassList[0].Replacment = class'ApocGameMode.ClassicPawn_ZedClot_Cyst_Default';
        AIClassList[1].Replacment = class'ApocGameMode.ClassicPawn_ZedClot_Alpha_Default';
        AIClassList[2].Replacment = class'ApocGameMode.ClassicPawn_ZedClot_AlphaKing_Default';
        AIClassList[3].Replacment = class'ApocGameMode.ClassicPawn_ZedClot_Slasher_Default';
        AIClassList[4].Replacment = class'ApocGameMode.ClassicPawn_ZedCrawler_Default';
        AIClassList[5].Replacment = class'ApocGameMode.ClassicPawn_ZedGorefast_Default';
        AIClassList[6].Replacment = class'ApocGameMode.ClassicPawn_ZedStalker_Default';
        AIClassList[7].Replacment = class'ApocGameMode.ClassicPawn_ZedScrake_Default';
        AIClassList[8].Replacment = class'ApocGameMode.ClassicPawn_ZedFleshpound_Default';
        AIClassList[9].Replacment = class'ApocGameMode.ClassicPawn_ZedFleshpoundMini_Default';
        AIClassList[10].Replacment = class'ApocGameMode.ClassicPawn_ZedBloat_Default';
        AIClassList[11].Replacment = class'ApocGameMode.ClassicPawn_ZedSiren_Default';
        AIClassList[12].Replacment = class'ApocGameMode.ClassicPawn_ZedHusk_Default';
        AIClassList[13].Replacment = class'ApocGameMode.ClassicPawn_ZedPatriarch_Default';
        AIClassList[14].Replacment = class'ApocGameMode.ClassicPawn_ZedHans_Default';
        AIClassList[15].Replacment = class'ApocGameMode.ClassicPawn_ZedBloatKing_Default';
        AIClassList[16].Replacment = class'ApocGameMode.ClassicPawn_ZedFleshpoundKing_Default';
        AIClassList[17].Replacment = class'ApocGameMode.ClassicPawn_ZedMatriarch_Default';
    }
...
function SetupDefaultConfig()
{
    ...
    if( iVersionNumber <= 0 )
    {
        ...
        foreach SaleItems(TraderItem)
        {
            ...
            switch(WepDef.Name)
            {
                // OFF-PERK
                case 'KFWeapDef_9mm':
                    DefPath = "ApocGameMode.ClassicWeapDef_9mm";
                    break;
                case 'KFWeapDef_9mmDual':
                    DefPath = "ApocGameMode.ClassicWeapDef_9mmDual";
                    break;
                // BERSERKER
                case 'KFWeapDef_Crovel':
                    DefPath = "ApocGameMode.ClassicWeapDef_Crovel";
                    break;
                case 'KFWeapDef_Katana':
                    DefPath = "ApocGameMode.ClassicWeapDef_Katana";
                    break;
                case 'KFWeapDef_Zweihander':
                    DefPath = "ApocGameMode.ClassicWeapDef_Zweihander";
                    break;
                case 'KFWeapDef_FireAxe':
                    DefPath = "ApocGameMode.ClassicWeapDef_FireAxe";
                    break;
                case 'KFWeapDef_AbominationAxe':
                    DefPath = "ApocGameMode.ClassicWeapDef_AbominationAxe";
                    break;
                // COMMANDO
                case 'KFWeapDef_Bullpup':
                    DefPath = "ApocGameMode.ClassicWeapDef_Bullpup";
                    break;
                case 'KFWeapDef_P90':
                    DefPath = "ApocGameMode.ClassicWeapDef_P90";
                    break;
                case 'KFWeapDef_AK12':
                    DefPath = "ApocGameMode.ClassicWeapDef_AK12";
                    break;
                case 'KFWeapDef_HK_UMP':
                    DefPath = "ApocGameMode.ClassicWeapDef_HK_UMP";
                    break;
                case 'KFWeapDef_SCAR':
                    DefPath = "ApocGameMode.ClassicWeapDef_SCAR";
                    break;
                case 'KFWeapDef_Stoner63A':
                    DefPath = "ApocGameMode.ClassicWeapDef_Stoner63A";
                    break;
                case 'KFWeapDef_Thompson':
                    DefPath = "ApocGameMode.ClassicWeapDef_Thompson";
                    break;
                // SUPPORT
                case 'KFWeapDef_MB500':
                    DefPath = "ApocGameMode.ClassicWeapDef_MB500";
                    break;
                case 'KFWeapDef_DoubleBarrel':
                    DefPath = "ApocGameMode.ClassicWeapDef_DoubleBarrel";
                    break;
                case 'KFWeapDef_M4':
                    DefPath = "ApocGameMode.ClassicWeapDef_M4";
                    break;
                case 'KFWeapDef_HZ12':
                    DefPath = "ApocGameMode.ClassicWeapDef_HZ12";
                    break;
                case 'KFWeapDef_Nailgun':
                    DefPath = "ApocGameMode.ClassicWeapDef_NailGun";
                    break;
                case 'KFWeapDef_ElephantGun':
                    DefPath = "ApocGameMode.ClassicWeapDef_ElephantGun";
                    break;
                case 'KFWeapDef_AA12':
                    DefPath = "ApocGameMode.ClassicWeapDef_AA12";
                    break;
                // MEDIC
                case 'KFWeapDef_MedicPistol':
                    DefPath = "ApocGameMode.ClassicWeapDef_MedicPistol";
                    break;
                case 'KFWeapDef_MedicSMG':
                    DefPath = "ApocGameMode.ClassicWeapDef_MedicSMG";
                    break;
                case 'KFWeapDef_MedicShotgun':
                    DefPath = "ApocGameMode.ClassicWeapDef_MedicShotgun";
                    break;
                case 'KFWeapDef_MedicRifle':
                    DefPath = "ApocGameMode.ClassicWeapDef_MedicRifle";
                    break;
                case 'KFWeapDef_MP7':
                    DefPath = "ApocGameMode.ClassicWeapDef_MP7";
                    break;
                case 'KFWeapDef_MP5RAS':
                    DefPath = "ApocGameMode.ClassicWeapDef_MP5RAS";
                    break;
                case 'KFWeapDef_Kriss':
                    DefPath = "ApocGameMode.ClassicWeapDef_Kriss";
                    break;
                // DEMOLITIONIST
                case 'KFWeapDef_HX25':
                    DefPath = "ApocGameMode.ClassicWeapDef_HX25";
                    break;
                case 'KFWeapDef_C4':
                    DefPath = "ApocGameMode.ClassicWeapDef_C4";
                    break;
                case 'KFWeapDef_M79':
                    DefPath = "ApocGameMode.ClassicWeapDef_M79";
                    break;
                case 'KFWeapDef_Seeker6':
                    DefPath = "ApocGameMode.ClassicWeapDef_Seeker6";
                    break;
                case 'KFWeapDef_M16M203':
                    DefPath = "ApocGameMode.ClassicWeapDef_M16M203";
                    break;
                case 'KFWeapDef_RPG7':
                    DefPath = "ApocGameMode.ClassicWeapDef_RPG7";
                    break;
                case 'KFWeapDef_M32':
                    DefPath = "ApocGameMode.ClassicWeapDef_M32";
                    break;
                // FIREBUG
                case 'KFWeapDef_FlareGun':
                    DefPath = "ApocGameMode.ClassicWeapDef_FlareGun";
                    break;
                case 'KFWeapDef_FlareGunDual':
                    DefPath = "ApocGameMode.ClassicWeapDef_FlareGunDual";
                    break;
                case 'KFWeapDef_Mac10':
                    DefPath = "ApocGameMode.ClassicWeapDef_Mac10";
                    break;
                case 'KFWeapDef_FlameThrower':
                    DefPath = "ApocGameMode.ClassicWeapDef_FlameThrower";
                    break;
                case 'KFWeapDef_DragonsBreath':
                    DefPath = "ApocGameMode.ClassicWeapDef_DragonsBreath";
                    break;
                case 'KFWeapDef_HuskCannon':
                    DefPath = "ApocGameMode.ClassicWeapDef_HuskCannon";
                    break;
                // SHARPSHOOTER
                case 'KFWeapDef_Colt1911':
                    DefPath = "ApocGameMode.ClassicWeapDef_Colt1911";
                    break;
                case 'KFWeapDef_Colt1911Dual':
                    DefPath = "ApocGameMode.ClassicWeapDef_Colt1911Dual";
                    break;
                case 'KFWeapDef_SW500':
                    DefPath = "ApocGameMode.ClassicWeapDef_SW500";
                    break;
                case 'KFWeapDef_SW500Dual':
                    DefPath = "ApocGameMode.ClassicWeapDef_SW500Dual";
                    break;
                case 'KFWeapDef_Deagle':
                    DefPath = "ApocGameMode.ClassicWeapDef_Deagle";
                    break;
                case 'KFWeapDef_DeagleDual':
                    DefPath = "ApocGameMode.ClassicWeapDef_DeagleDual";
                    break;
                case 'KFWeapDef_Winchester1894':
                    DefPath = "ApocGameMode.ClassicWeapDef_Winchester1894";
                    break;
                case 'KFWeapDef_Crossbow':
                    DefPath = "ApocGameMode.ClassicWeapDef_Crossbow";
                    break;
                case 'KFWeapDef_CenterfireMB464':
                    DefPath = "ApocGameMode.ClassicWeapDef_CenterfireMB464";
                    break;
                case 'KFWeapDef_M14EBR':
                    DefPath = "ApocGameMode.ClassicWeapDef_M14EBR";
                    break;
                case 'KFWeapDef_M99':
                    DefPath = "ApocGameMode.ClassicWeapDef_M99";
                    break;
            }
        ...
        Perks.AddItem("ApocGameMode.ClassicPerk_Medic");
    ...
    if( iVersionNumber <= 3 )
    {
        ...
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_MKB42") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_MKB42");
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_FNFal") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_FNFal");
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_MedicRifleGrenadeLauncher") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_MedicRifleGrenadeLauncher");
    ...
    if( iVersionNumber <= 4 )
    {
        ...
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_Thompson") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_Thompson");
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_M32") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_M32");
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_FireAxe") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_FireAxe");
        if( TraderInventory.Find("ApocGameMode.ClassicWeapDef_AbominationAxe") == INDEX_NONE )
            TraderInventory.AddItem("ApocGameMode.ClassicWeapDef_AbominationAxe");
    ...
    if( iVersionNumber <= 5 )
    {
        ...
        DefaultProfile = New(None, "ExampleProfile") class'ZEDReplacmentInfo';
            ...
            ReplacementInfo.Replacment = "ApocGameMode.ClassicPawn_ZedCrawler";
...
function InitializePerks( ClassicPlayerController Other )
{
    ...
    if( bDisableGameplayChanges )
    {
        ...
        {
            Index = LoadedPerks.Find(class'ApocGameMode.ClassicPerk_Gunslinger_Default');
            if( Index == INDEX_NONE )
                LoadedPerks.AddItem(class'ApocGameMode.ClassicPerk_Gunslinger_Default');
        }

        if( !bDisableSWAT )
        {
            Index = LoadedPerks.Find(class'ApocGameMode.ClassicPerk_SWAT_Default');
            if( Index == INDEX_NONE )
...
defaultproperties
{
    ...
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedClot_Cyst', Replacment=class'ApocGameMode.ClassicPawn_ZedClot_Alpha'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedClot_Alpha', Replacment=class'ApocGameMode.ClassicPawn_ZedClot_Alpha'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedClot_AlphaKing', Replacment=class'ApocGameMode.ClassicPawn_ZedClot_Alpha'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedClot_Slasher', Replacment=class'ApocGameMode.ClassicPawn_ZedClot_Alpha'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedCrawler', Replacment=class'ApocGameMode.ClassicPawn_ZedCrawler'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedGorefast', Replacment=class'ApocGameMode.ClassicPawn_ZedGorefast'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedStalker', Replacment=class'ApocGameMode.ClassicPawn_ZedStalker'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedScrake', Replacment=class'ApocGameMode.ClassicPawn_ZedScrake'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedFleshpound', Replacment=class'ApocGameMode.ClassicPawn_ZedFleshpound'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedFleshpoundMini', Replacment=class'ApocGameMode.ClassicPawn_ZedScrake'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedBloat', Replacment=class'ApocGameMode.ClassicPawn_ZedBloat'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedSiren', Replacment=class'ApocGameMode.ClassicPawn_ZedSiren'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedHusk', Replacment=class'ApocGameMode.ClassicPawn_ZedHusk'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedPatriarch', Replacment=class'ApocGameMode.ClassicPawn_ZedPatriarch'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedHans', Replacment=class'ApocGameMode.ClassicPawn_ZedPatriarch'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedBloatKing', Replacment=class'ApocGameMode.ClassicPawn_ZedPatriarch'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedFleshpoundKing', Replacment=class'ApocGameMode.ClassicPawn_ZedPatriarch'))
    AIClassList.Add((Original=class'KFGameContent.KFPawn_ZedMatriarch', Replacment=class'ApocGameMode.ClassicPawn_ZedPatriarch'))

    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_9mm', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_9mm'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_Dual9mm', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_Dual9mm'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Blunt_Crovel', ReplacmentClass=class'ApocGameMode.ClassicWeap_Blunt_Crovel'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_GrenadeLauncher_HX25', ReplacmentClass=class'ApocGameMode.ClassicWeap_GrenadeLauncher_HX25'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_Colt1911', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_Colt1911'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_Medic', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_Medic'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Rifle_Winchester1894', ReplacmentClass=class'ApocGameMode.ClassicWeap_Rifle_Winchester1894'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_MB500', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_MB500'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_MP7', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_MP7'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_Flare', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_Flare'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Pistol_Deagle', ReplacmentClass=class'ApocGameMode.ClassicWeap_Pistol_Deagle'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_AssaultRifle_Bullpup', ReplacmentClass=class'ApocGameMode.ClassicWeap_AssaultRifle_Bullpup'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Thrown_C4', ReplacmentClass=class'ApocGameMode.ClassicWeap_Thrown_C4'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_GrenadeLauncher_M79', ReplacmentClass=class'ApocGameMode.ClassicWeap_GrenadeLauncher_M79'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_Medic', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_Medic'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_DragonsBreath', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_DragonsBreath'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Rifle_CenterfireMB464', ReplacmentClass=class'ApocGameMode.ClassicWeap_Rifle_CenterfireMB464'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Bow_Crossbow', ReplacmentClass=class'ApocGameMode.ClassicWeap_Bow_Crossbow'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_MP5RAS', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_MP5RAS'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Revolver_SW500', ReplacmentClass=class'ApocGameMode.ClassicWeap_Revolver_SW500'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_Nailgun', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_Nailgun'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_DoubleBarrel', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_DoubleBarrel'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_HZ12', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_HZ12'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Edged_Katana', ReplacmentClass=class'ApocGameMode.ClassicWeap_Edged_Katana'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_AssaultRifle_AK12', ReplacmentClass=class'ApocGameMode.ClassicWeap_AssaultRifle_AK12'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_Medic', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_Medic'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_M4', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_M4'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Rifle_M14EBR', ReplacmentClass=class'ApocGameMode.ClassicWeap_Rifle_M14EBR'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_P90', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_P90'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_Mac10', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_Mac10'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Flame_Flamethrower', ReplacmentClass=class'ApocGameMode.ClassicWeap_Flame_Flamethrower'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_AssaultRifle_M16M203', ReplacmentClass=class'ApocGameMode.ClassicWeap_AssaultRifle_M16M203'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_HK_UMP', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_HK_UMP'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Edged_Zweihander', ReplacmentClass=class'ApocGameMode.ClassicWeap_Edged_Zweihander'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_AA12', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_AA12'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Shotgun_ElephantGun', ReplacmentClass=class'ApocGameMode.ClassicWeap_Shotgun_ElephantGun'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_AssaultRifle_SCAR', ReplacmentClass=class'ApocGameMode.ClassicWeap_AssaultRifle_SCAR'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_LMG_Stoner63A', ReplacmentClass=class'ApocGameMode.ClassicWeap_LMG_Stoner63A'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_AssaultRifle_Medic', ReplacmentClass=class'ApocGameMode.ClassicWeap_AssaultRifle_Medic'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_SMG_Kriss', ReplacmentClass=class'ApocGameMode.ClassicWeap_SMG_Kriss'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_RocketLauncher_RPG7', ReplacmentClass=class'ApocGameMode.ClassicWeap_RocketLauncher_RPG7'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_RocketLauncher_Seeker6', ReplacmentClass=class'ApocGameMode.ClassicWeap_RocketLauncher_Seeker6'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_HuskCannon', ReplacmentClass=class'ApocGameMode.ClassicWeap_HuskCannon'))
    DefaultWeaponReplacements.Add((OriginalClass=class'KFGameContent.KFWeap_Rifle_M99', ReplacmentClass=class'ApocGameMode.ClassicWeap_Rifle_M99'))
}
