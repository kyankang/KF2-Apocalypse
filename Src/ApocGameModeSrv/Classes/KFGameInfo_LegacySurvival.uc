...
function PostBeginPlay()
{
    ...
    if( !bSavedGametypes )
    {
        ...
        GameMode.ClassNameAndPath = "ApocGameModeSrv.KFGameInfo_LegacySurvival";
...
static event class<GameInfo> SetGameType(string MapName, string Options, string Portal)
{
	...
	{
        return class<GameInfo>(DynamicLoadObject("ApocClassicMenu.KFGameInfo_LegacyEntry", class'Class'));
	}
