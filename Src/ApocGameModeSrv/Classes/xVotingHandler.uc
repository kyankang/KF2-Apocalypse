...
function PostBeginPlay()
{
    ...
    iCurrentHistory = class'ApocGameModeSrv.xMapVoteHistory'.Static.GetMapHistory(MapFile,WorldInfo.Title);
    ...
    for( i=(Class'KFGameInfo'.Default.GameMapCycles.Length-1); i>=0; --i )
    {
        for( j=(Class'KFGameInfo'.Default.GameMapCycles[i].Maps.Length-1); j>=0; --j )
        {
            ...
            n = class'ApocGameModeSrv.xMapVoteHistory'.Static.GetMapHistory(Maps[z].MapName,"");
            class'ApocGameModeSrv.xMapVoteHistory'.Static.GetHistory(n,UpV,DownV,Seq,NumPl,S);
            Maps[z].UpVotes = UpV;
...
function SetupBroadcast()
{
    ...
    B = Spawn(class'ApocGameModeSrv.xVoteBroadcast');
    B.Handler = Self;
    ...
    if( !bNoWebAdmin )
    {
        ...
        if( W!=None )
        {
            ...
            if( A!=None )
            {
                xW = new (None) class'ApocGameModeSrv.xVoteWebApp';
...
final function LoginPlayer( PlayerController PC )
{
    ...
    for( i=(ActiveVoters.Length-1); i>=0; --i )
        if( ActiveVoters[i].PlayerOwner==PC )
            return;
    R = Spawn(class'ApocGameMode.xVotingReplication',PC);
    R.VoteHandler = Self;
...
defaultproperties
{
    ...
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_one_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_two_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_three_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_four_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_five_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_six_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_seven_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_eight_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_nine_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_ten_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_20_seconds_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_30_seconds_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_1_minute_Cue')
    AnnouncerCues.Add(SoundCue'ApocxVoteAnnouncer.VX_HolyShit_Cue')
}
